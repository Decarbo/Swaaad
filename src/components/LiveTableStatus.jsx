...
export default function LiveTableStatus() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl font-bold mt-14 text-yellow-400 mb-8 text-center flex justify-center items-center gap-3">
         Live Table
      </h2>
        ...
        {[...Array(40)].map((_, i) => {
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-2xl backdrop-blur-lg p-4 text-center cursor-pointer border transition-all duration-300 ${
                isAvailable
                  ? "bg-green-400/10 border-green-400 hover:bg-green-400/20"
                  : "bg-red-400/10 border-red-400 hover:bg-red-400/20"
              }`}
            >
              ...
              {/* glowing dot */}
              <div
                className={`w-3 h-3 rounded-full mx-auto mt-2 animate-pulse ${
              ...
              {booked && (
                ...
                >
                  <Users className="text-yellow-400 mb-1" size={18} />
                  <p className="font-semibold">{booked.user}</p>
                  <p className="text-gray-400">Status: {booked.status}</p>
                  {booked.specialNote && (
                    <p className="italic text-gray-400 mt-1 text-center px-1">
                      “{booked.specialNote}”
                    </p>
                  )}
                </motion.div>
